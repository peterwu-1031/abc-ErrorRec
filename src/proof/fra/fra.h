...
// Yu-Cheng added
extern int                 Fra_FraigSatAll( sat_solver ** pSat, Aig_Man_t * pMan, ABC_INT64_T nConfLimit, ABC_INT64_T nInsLimit, int nLearnedStart, int nLearnedDelta, int nLearnedPerce, int fFlipBits, int fAndOuts, int fNewSolver, int fVerbose );
/*=== fraClass.c ========================================================*/
